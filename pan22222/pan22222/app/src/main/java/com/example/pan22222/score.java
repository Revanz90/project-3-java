...
public class score extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView namaTimA = findViewById(R.id.textView3);
    ...
    public void tambah(View view) {
        ...
        TextView skorTimA = findViewById(R.id.textView6);
        TextView skorTimB = findViewById(R.id.textView5);
